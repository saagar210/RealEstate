...
mod tests {
    ...
    use realestate_lib::commands::property::*;
    ...
    async fn test_create_property_command() {
        ...
        assert_eq!(property.price, 750_000_00);
    ...
    async fn test_update_property_command() {
        ...
        updated_input.price = 850_000_00;
        ...
        assert_eq!(updated.price, 850_000_00);
